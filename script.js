...
switchThemeBtn.addEventListener("click",  () => {
  if(switchThemeBtn.innerHTML == '<i class="fa-solid fa-sun"></i>') {
    ...
    if(main.classList == "contact") {
      ...
      const contactFormulage = document.querySelector("main.contact .formulage");
      const contactContactInformation = document.querySelector("main.contact .contact-information");
